...
const questionsByCategory = [
    ...
    },
    {
        ...
        questions: ['What are your skills?', 'How was your experience working as freelancer?'],
    },
    {
        id: 'contact',
        name: 'Contact & Future',
...
export default function HelperBoost({ submitQuery, setInput, handlePresetReply }: HelperBoostProps) {
