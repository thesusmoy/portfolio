    ...
    return (
        <CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
            <div className="relative w-full">
                ...
                >
                    <div className={cn('absolute right-0 z-10 h-auto w-[5%] overflow-hidden bg-linear-to-l')}></div>
...
export const Card = ({ card, index, layout = false }: { card: Card; index: number; layout?: boolean }) => {
    ...
    return (
        <>
            ...
            >
                <div className="absolute inset-x-0 top-0 z-30 h-full cursor-pointer bg-linear-to-b from-black hover:scale-110 via-transparent to-transparent" />
