        ...
        >
            ...
            <div className="mb-6 flex flex-col items-center sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-foreground text-2xl font-semibold">Susmoy Debnath</h2>
                        ...
                        <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
                            <ul className="decoration-none list-disc pl-4">
                                {data?.skills.technical
                                    ...
                                    <>
                                        <li>Go, Python, SQL, JavaScript, TypeScript, HTML/CSS</li>
                                        <li>Fiber, Express.js, Django, React.js, Angular</li>
                                        <li>Scikit-learn, TensorFlow, OpenCV</li>
                            ...
                            <ul className="list-disc pl-4">
                                {data?.skills.technical
                                    ...
                                    <>
                                        <li>
                                            AWS, GCP, Docker, Jenkins, Terraform, Git, GitHub, Agile, Jira, Kubernetes
                                        </li>
                                        <li>Firebase, SQL</li>
                                        <li>Machine Learning, AI Agents</li>
                                        <li>Automation, Research</li>
                                    </>
                                )}
                                <li>
                                    <a
            ...
            <div className="mt-10">
                ...
                <p className="text-foreground text-sm">
                    {data?.experience.internshipCompleted ||
                        'Real-world ML experience from MookMati (Genre classification, FastAPI deployment, AWS).'}{' '}
                    <br />
                    {data?.achievements[0] ||
                        '2nd position in Smart India Hackathon 2025 among 88,221 teams with hideFlare cybersecurity tool.'}{' '}
                    <br />
                    {data?.experience.freelanceWork ||
                        '25+ freelance automation projects delivered on Fiverr, cutting manual work by 60%.'}
                </p>
            </div>
            ...
            <div className="mt-8">
                ...
                <p className="text-foreground text-sm">
                    ...
                    I want to work on {data?.lookingFor.technicalChallenges || 'cutting-edge technologies'} that{' '}
                    {data?.lookingFor.impactfulWork || 'solve real-world problems and make a meaningful impact'}. I'm
                    passionate, adaptable, and ready to contribute to{' '}
                    {data?.lookingFor.collaboration || 'collaborative, innovative environments'}! 🚀
                </p>
            </div>
